  ...
  mustClauses.push({
    range: {
      [timeRangeObj?.date_field || "planned_start"]: {
        ...(plannedStartISO && { gte: plannedStartISO }),
        ...(plannedEndISO && { lte: plannedEndISO }),
        ...(timeRangeObj?.start && { gte: timeRangeObj.start }),
        ...(timeRangeObj?.end && { lte: timeRangeObj.end }),
      }
    }
  });
